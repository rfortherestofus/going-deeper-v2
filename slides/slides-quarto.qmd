...
I'll demonstrate making effective tables using `gt`, `flextable`, and `reactable`.
...
- customizing themes
- creating your own theme with sass variables
...
- Turn your report into a presentation

# Dashboards {.inverse background-image="assets/dashboard.jpg"}

- Layout
  - pages (level 1)
  - rows/columns (level 2)
...
- Use `quarto publish` in terminal
- Quartopub.com
- Netlify

## My Turn {.my-turn}

I'll publish my website to:
