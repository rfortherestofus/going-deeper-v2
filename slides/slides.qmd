...
4. Import the RDS file into a data frame called `third_grade_math_proficiency`.
...
1. Download a slightly modified version of the enrollment data by race/ethnicity from the URL below and save it in a `data` folder (create it if necessary).

1. Create a data frame called `enrollment_by_race_ethnicity` by reading in the data you just downloaded.

## Your Turn, Continued {.your-turn}

4. Pipe your data into a bar chart that shows the breakdown of race/ethnicity among students in Beaverton SD 48J in 2022-2023.
...
Highlight a single district in your line chart that had an increase in its Hispanic/Latino population between 2021-2022 and 2022-2023
...
Complete themes like `theme_minimal()` etc completely change the look and feel of plots
