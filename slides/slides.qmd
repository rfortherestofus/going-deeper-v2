...
<!-- background-image:url("assets/code-heart.jpg") -->
...
<!-- background-image:url("assets/circle-pattern.jpg") -->
...
<!-- background-image:url("assets/ship-export.jpg") -->
